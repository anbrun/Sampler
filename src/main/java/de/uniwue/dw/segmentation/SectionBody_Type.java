 ...
 * @generated */
public class SectionBody_Type extends Annotation_Type {
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uniwue.dw.segmentation.SectionBody");
  ...
  public String getCategory(int addr) {
      ...
      jcas.throwFeatMissing("category", "de.uniwue.dw.segmentation.SectionBody");
