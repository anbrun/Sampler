...
public class Segment_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.uniwue.dw.segmentation.Segment");
  ...
  public String getCategory(int addr) {
      ...
      jcas.throwFeatMissing("category", "de.uniwue.dw.segmentation.Segment");
