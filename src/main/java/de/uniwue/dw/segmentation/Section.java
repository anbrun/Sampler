...
public class Section extends Annotation {
  ...
  */  
  ...
  public String getCategory() {
    if (Section_Type.featOkTst && ((Section_Type)jcasType).casFeat_category == null)
      jcasType.jcas.throwFeatMissing("category", "de.uniwue.dw.segmentation.Section");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Section_Type)jcasType).casFeatCode_category);}
  ...
  public void setCategory(String v) {
    if (Section_Type.featOkTst && ((Section_Type)jcasType).casFeat_category == null)
      jcasType.jcas.throwFeatMissing("category", "de.uniwue.dw.segmentation.Section");
    jcasType.ll_cas.ll_setStringValue(addr, ((Section_Type)jcasType).casFeatCode_category, v);}    
  }
