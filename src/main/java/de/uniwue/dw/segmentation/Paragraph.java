...
public class Paragraph extends Annotation {
  ...
  */  
  ...
  public String getCategory() {
    if (Paragraph_Type.featOkTst && ((Paragraph_Type)jcasType).casFeat_category == null)
      jcasType.jcas.throwFeatMissing("category", "de.uniwue.dw.segmentation.Paragraph");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Paragraph_Type)jcasType).casFeatCode_category);}
  ...
  public void setCategory(String v) {
    if (Paragraph_Type.featOkTst && ((Paragraph_Type)jcasType).casFeat_category == null)
      jcasType.jcas.throwFeatMissing("category", "de.uniwue.dw.segmentation.Paragraph");
    jcasType.ll_cas.ll_setStringValue(addr, ((Paragraph_Type)jcasType).casFeatCode_category, v);}    
  }
